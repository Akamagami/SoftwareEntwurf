...
public class ElementLocationFactory implements ElementFactory {
	...
	public Object create(Object[] params, Optional<String> optId) {
		...
		Location ret = new Location((String) params[0],(String) params[1],(double) params[2],(String) params[3],(String) params[4],newIndex);
		return ret;
	}
