...
public class ElementMusikFactory implements ElementFactory {
	...
	public Object create(Object[] params, Optional<String> optId) {
		...
		Musik ret = new Musik((String) params[0],(String) params[1],(double) params[2],(String) params[3],(String) params[4],newIndex);
		return ret;
	}
